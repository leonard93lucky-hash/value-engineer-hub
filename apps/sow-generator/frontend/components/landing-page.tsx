...
export function LandingPage({ currentUser, onLogout, onSelectProduct }: LandingPageProps) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans relative overflow-hidden">
      ...
      {/* MAIN CONTENT */}
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-6 sm:p-6 relative z-10 w-full max-w-5xl mx-auto">

        <div className="text-center mb-8 sm:mb-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
          <h1 className="text-xl sm:text-3xl md:text-5xl font-extrabold text-gray-900 mb-3 sm:mb-5 tracking-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 w-full max-w-6xl animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-150 fill-mode-both">
          ...
          <button
            ...
            className="group text-left relative bg-white border border-gray-200 hover:border-red-400 rounded-2xl sm:rounded-3xl p-5 sm:p-8 transition-all duration-500 overflow-hidden shadow-lg hover:shadow-2xl hover:shadow-red-500/10 flex flex-col h-full transform hover:-translate-y-1 cursor-pointer"
          >
            ...
            <div className="w-12 h-12 sm:w-16 sm:h-16 bg-red-50 rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 shadow-sm border border-red-100 group-hover:bg-red-500 transition-colors duration-500">
              <Smartphone className="w-6 h-6 sm:w-8 sm:h-8 text-red-500 group-hover:text-white transition-colors duration-500" />
            </div>

            <h2 className="text-lg sm:text-2xl font-bold text-gray-900 mb-2 sm:mb-3 flex items-center gap-2 sm:gap-3">
              SDK Liveness
            ...
            <p className="text-gray-500 text-sm leading-relaxed mb-5 sm:mb-8 flex-1">
          ...
          <button
            ...
            className="group text-left relative bg-white border border-gray-200 hover:border-blue-400 rounded-2xl sm:rounded-3xl p-5 sm:p-8 transition-all duration-500 overflow-hidden shadow-lg hover:shadow-2xl hover:shadow-blue-500/10 flex flex-col h-full transform hover:-translate-y-1 cursor-pointer"
          >
            ...
            <div className="w-12 h-12 sm:w-16 sm:h-16 bg-blue-50 rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 shadow-sm border border-blue-100 group-hover:bg-blue-500 transition-colors duration-500">
              <Code2 className="w-6 h-6 sm:w-8 sm:h-8 text-blue-500 group-hover:text-white transition-colors duration-500" />
            </div>
          ...
          <button
            ...
            className="group text-left relative bg-white border border-gray-200 hover:border-emerald-400 rounded-2xl sm:rounded-3xl p-5 sm:p-8 transition-all duration-500 overflow-hidden shadow-lg hover:shadow-2xl hover:shadow-emerald-500/10 flex flex-col h-full transform hover:-translate-y-1 cursor-pointer"
          >
            ...
            <div className="w-12 h-12 sm:w-16 sm:h-16 bg-emerald-50 rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 shadow-sm border border-emerald-100 group-hover:bg-emerald-500 transition-colors duration-500">
              <Lock className="w-6 h-6 sm:w-8 sm:h-8 text-emerald-500 group-hover:text-white transition-colors duration-500" />
            </div>
